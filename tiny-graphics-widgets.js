...
const Code_Widget = (widgets.Code_Widget = class Code_Widget {
    ...
    constructor(element, main_scene, additional_scenes, options = {}) {
        ...
        import("./main-scene.js").then((module) => {
            ...
            if (!options.hide_navigator) this.build_navigator(element, main_scene, additional_scenes, module.defs);
        });
    }
    ...
    display_code(class_to_display) {
        ...
        if (this.associated_editor_widget) this.associated_editor_widget.select_class(class_to_display);
...
const Text_Widget = (widgets.Text_Widget = class Text_Widget {
    ...
    render(time = 0) {
        if (this.scenes[0]) this.scenes[0].show_explanation(this.element, this.webgl_manager);
