...
export class Background extends Scene {
    constructor() {
        ...
        this.materials = {
            ...
            nx: new Material(new Texture_Scroll_X(), {ambient: 1, texture: new Texture("assets/CloudyCrown_Midday_Left.png")}),
            ny: new Material(new Texture_Scroll_X(), {ambient: 1, texture: new Texture("assets/CloudyCrown_Midday_Down.png")}),
            nz: new Material(new Texture_Scroll_X(), {ambient: 1, texture: new Texture("assets/CloudyCrown_Midday_Back.png")}),
            px: new Material(new Texture_Scroll_X(), {ambient: 1, texture: new Texture("assets/CloudyCrown_Midday_Right.png")}),
            py: new Material(new Texture_Scroll_X(), {ambient: 1, texture: new Texture("assets/CloudyCrown_Midday_Up.png")}),
